...
void solve() {
	...
	while (t--) {
		...
		while(i<r1.length())
		{
			if(rowindex==1 && columnindex==r2.length()-1)
			{
				cout<<"YES"<<nline;
				break;
			}
			else
			{
				if(rowindex==0)
				{
					if(r1[columnindex+1]=='0')
					{
						columnindex++;
						i++;
					}
					else if(r2[columnindex]=='0')
					{
						rowindex++;
					}
					else if(r2[columnindex+1]=='0')
					{
						rowindex++;
						i++;
						columnindex++;
				...
				{
					if(r2[columnindex+1]=='0')
					{
						columnindex++;
						i++;
					}
					else if(r1[columnindex]=='0')
					{
						rowindex--;
					}
					else if(r1[columnindex+1]=='0')
					{
						rowindex--;
						columnindex++;
						i++;
